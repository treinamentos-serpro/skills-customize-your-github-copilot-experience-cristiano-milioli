...
- `# 📘 Atividade: [Título da Atividade]` — Substitua `[Título da Atividade]` por um nome curto e descritivo (ex: `Python Basics`, `Loops and Conditionals`, `Functions and Modules`).
